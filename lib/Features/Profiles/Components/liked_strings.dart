...
class LikedStringsComponent extends StatefulWidget {
  final int profileId;
  const LikedStringsComponent({super.key, required this.profileId});

  @override
  State<LikedStringsComponent> createState() => _LikedStringsComponentState();
}

class _LikedStringsComponentState extends State<LikedStringsComponent> {
  List<dynamic> posts = [];
  ...
  Future<void> _fetchLikedPosts() async {
    ...
    try {
      ...
      LogService.logError('an error occurred');
    }
  }
